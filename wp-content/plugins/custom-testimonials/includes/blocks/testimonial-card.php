...
class Testimonial_Card extends Skeletor_Block {
	...
	public static $field_group = [
        ...
        [
            'key' => 'field_testimonial_show_title_with_company',
            'label' => 'Show Title',
            'name' => 'testimonial_show_title_with_company',
            'type' => 'true_false',
            'ui' => 1,
            'ui_on_text' => 'Yes',
            'ui_off_text' => 'No',
    ...
    public static function before_render($block_data) : array {
        ...
        if ($block_data['testimonial_show_title_with_company']) {
            $block_data['heading'] = get_the_title($id);
        }
